...
qiime tools import --type 'FeatureData[Taxonomy]' \
  ...
  --input-path /scratch_vol1/fungi/Diversity_in_Mare_yam_crop/98_database_files/ITS/Taxonomy-UNITE-V7-S-2017.12.01-dynamic.txt \
...
qiime tools import --type 'FeatureData[Sequence]' \
  --input-path /scratch_vol1/fungi/Diversity_in_Mare_yam_crop/98_database_files/ITS/Sequence-UNITE-V7-S-2017.12.01-dynamic.fasta \
